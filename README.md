...
4º If you don't wants use 1000 slots, you can delete species lines
5º Compile the rom
6º (OPTIONAL) If you want (recommended) add CFRU, edit the pokemon files for add the species
